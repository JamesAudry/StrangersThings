...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Routes>
        <Route exact path='/account/:method' element={<Account setUser={setUser} setToken={setToken} setMessages={setMessages} />} />
        ...
        <Route exact path='/posts/:postId/messages' element={<Message token={token} setPosts={setPosts} fetchPosts={fetchPosts} posts={posts} />} />
        <Route path='/posts/:postId/edit' element={<Edit posts={posts} setPosts={setPosts} token={token} fetchPosts={fetchPosts}/>} />
      </Routes>
    </div >
  );
}
